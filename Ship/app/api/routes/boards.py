...
def update_board_details(
    ...
    try:
        ...
        AuditLogger.log_security_event(
            event_type="BOARD_UPDATED", severity="info", details={"board_id": board_id, "user_id": current_user.user_id}
        )
...
def get_board_details(
    ...
    try:
        ...
        AuditLogger.log_data_access(
            user_id=current_user.user_id, resource_type="board", resource_id=board_id, action="READ"
        )
...
def get_board_details_by_game_and_player(
    ...
    AuditLogger.log_data_access(
        user_id=current_user.user_id, resource_type="board", resource_id=board.board_id, action="READ"
    )
